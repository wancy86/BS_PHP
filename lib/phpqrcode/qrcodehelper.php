...
function get_invite_login_link($img_path,$uid,$url){
    ...
    if($uid<>"")
    {
        ...
        $img_url="/BoyStyle/images/QR_CODE/".$uid.".png";
        //TODO 文件不存在则生成
        ...
        // echo '<img src="/BoyStyle/images/QR_CODE/007_4.png"/>';
    }
    return $img_url;
}

// test 
//http://localhost/boystyle/lib/phpqrcode/qrcodehelper.php?fn_test
if(isset($_GET['fn_test'])){
    // echo "二维码图片";
    $img_src= get_invite_login_link(QRCODE_PATH,'1001','http://localhost/boystyle/reg.php?invite_by=1');
    echo '<img src="'.$img_src.'"/>';
    exit();
}

// test link
//http://localhost/boystyle/lib/phpqrcode/qrcodehelper.php?qrtest=1
if(isset($_GET['qrtest'])){
    ...
    echo '<img src="/BoyStyle/images/QR_CODE/007_1.png"/>';
    echo '<img src="/BoyStyle/images/QR_CODE/007_2.png"/>';
    echo '<img src="/BoyStyle/images/QR_CODE/007_3.png"/>';
    echo '<img src="/BoyStyle/images/QR_CODE/007_4.png"/>';
    exit();
}
